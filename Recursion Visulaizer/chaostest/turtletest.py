...
class ScrolledCanvas(TK.Frame):
    ...
    """
    def init(self, master, width=500, height=350, canvwidth=600, canvheight=500, configuration: Configuration=None, secrets: Secrets=None)-> Any:
        TK.Frame.init(self, master, width=width, height=height)
...
class TurtleScreen(TurtleScreenBase):
    ...
    def incrementudc(self,configuration: Configuration=None,secrets: Secrets=None)->Any:
...
class TNavigator(object):
    ...
    def right(self, angle,configuration: Configuration=None,secrets: Secrets=None)->Any:
